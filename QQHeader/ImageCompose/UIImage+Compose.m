...
+ (UIImage *)drawImageWithImagePath:(UIImage *)image contextSize:(CGSize)size degrees:(NSInteger)degrees isClip:(BOOL)isClip backgroundColor:(UIColor *)backgroundColor
{
